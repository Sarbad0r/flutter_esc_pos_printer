...
import 'package:ams_printer/pdg_generator.dart';
  ...
  Widget _buildDev(BluetoothDevice dev) => GestureDetector(
      ...
      child: Container(
          ...
          decoration: BoxDecoration(
              color: Colors.grey.withOpacity(0.125), borderRadius: BorderRadius.circular(20)),
          child: Column(children: [
            Text(dev.name,
                style: const TextStyle(
                    color: Colors.lightBlue, fontSize: 16, fontWeight: FontWeight.bold)),
            const SizedBox(height: 10),
            Text(dev.address, style: const TextStyle(color: Colors.grey, fontSize: 14))
          ])));
}
